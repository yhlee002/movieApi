...
nohup java -jar -Dserver.port=8080 -Dspring.profiles.active=prod -Djava.net.preferIPv4Stack=true $DEPLOY_JAR > /home/ec2-user/app/api/logs/server.log 2>&1 < /dev/null &
